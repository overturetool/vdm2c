...
/* World.vdmrt 7:32 */
TVP ret_10 = vdmSumGC(DIST_CALL(B, B, vdmCloneGC(g_D_b, NULL), CLASS_ID_B_ID, 0, CLASS_B__Z7callLocEV), DIST_CALL(B, B, vdmCloneGC(g_D_b, NULL), CLASS_ID_B_ID, 0, CLASS_B__Z7callRemEV), &ret_10)
;
/* World.vdmrt 7:11 */
return ret_10;
}
